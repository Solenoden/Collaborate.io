    ...
    return (
        <div>
            ...
            <div className="text-white text-center" style={{backgroundColor: "#593F59", height: "100vh", overflow: "hidden"}}>
                ...
                <div className="text-white text-center mx-auto" style={{position: "absolute", bottom: "25px", left: "49.7vw"}}><p>SCROLL DOWN</p></div>
            </div>
                ...
                <div className="container mb-5">
                    ...
                    <div className="d-flex justify-content-center">
                        <div style={{width: "200px", marginRight: "50px"}}>
                            <img className="mx-auto" style={{width: "50px", height: "50px"}}/>
