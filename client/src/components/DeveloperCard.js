        ...
        if (this.props.cardType === "featured") {
            ...
            return (
                <Link to={"/developer/" + this.props.developer.developerID} style={{textDecoration: "none"}}>
                    <div className="d-flex flex-column" style={{width: "175px", height: "260px"}}>
                        <div className="bg-white flex-fill text-center">
                            <img className="rounded-circle mx-auto" style={{width: "92.5px", height: "92.5px", marginTop: "23px", marginBottom: "23px"}} src={this.props.developer.profilePic}/>
                        </div>
            ...
            return (
                <Link to={"/developer/" + this.props.developer.developerID} style={{textDecoration: "none"}}>
                    <div className="d-flex flex-row bg-white text-main" style={{width: "400px", height: "200px"}}>
                        <div className="w-50 h-100 text-center"> 
                            <img src={this.props.developer.profilePic} className="w-50 h-50 rounded-circle" style={{marginTop: "25%", marginBottom: "25%"}}/>
                        </div>
